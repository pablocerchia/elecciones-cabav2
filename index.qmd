...
El mandato de estos 30 legisladores durará 4 años.<br><br> Ellos se encargaran de sancionar leyes sobre los asuntos como  educación, salud, ambiente, obras públicas, diseño urbano y seguridad de la Ciudad. @cr-4anos
...
<span style="font-size: 48pt;">¿Dónde se vota?</span><br><br>Consultá en el sitio del Tribunal Electoral de CABA haciendo click <a href="https://electoralcaba.gob.ar/">aquí</a>. @cr-dondevota
...
:::{#cr-quienvota}
![](dnivotojoven (1).png){width=100%}
:::

:::{#cr-sidebar}
:::

<span style="font-size: 42pt;">¿Quién puede votar?</span><br><br>Podés votar si cumplís con los siguientes requisitos: @cr-quienvota

◇ Sos argentino/a o extranjero/a con residencia permanente.<br>◇ Sos mayor de 16 años (y haber renovado el DNI a los 14 años).<br>◇ Figuras en el padrón electoral.<br>◇ Tenés el DNI que figura en el padrón electoral para mostrarlo al momento de votar. @cr-quienvota
...
<span style="font-size: 48pt;">¿Cómo se vota?</span><br><br>Con Boleta única electrónica. @cr-comosevota

Un dispositivo con pantalla táctil te va a mostrar las listas oficializadas para que selecciones la de tu preferencia y se imprima tu boleta única. @cr-comosevota
...
:::{#cr-guia}
![](pregunta.png){width=100%}
:::

:::{#cr-sidebar}
:::

<span style="font-size: 48pt;">¿Quién es quién?</span><br><br>Al haber 17 alianzas es fácil perderse. @cr-guia
...
En el peronismo los principales representates son las listas de:<br><br>• Leandro Santoro (Es Ahora Buenos Aires)<br><br>• Alejandro Kim (Principios y Valores, la cual representa a Guillermo Moreno) @cr-aspecto_peronismo
...
Si querés informarte al respecto recomendamos ir a la sección de **"Candidatos"** y **"Propuestas"** donde podrás ver las listas completas y las principales propuestas de cada alianza. @cr-guia2
:::
